...
namespace MapDemo {
    ...
    public class DemoValuesProvider {
        const string key = "AhhH2QnNpS36rRPZ1Oi6zevrl5KFBSdlG4Q9ZV_V8lmd-JtoqcShx8-eYYmfXSFk";
        ...
        public IEnumerable<OpenStreetMapKind> OSMBaseLayers { get { return new OpenStreetMapKind[] { OpenStreetMapKind.Basic, OpenStreetMapKind.Mapquest, OpenStreetMapKind.MapquestSatellite, OpenStreetMapKind.CycleMap, OpenStreetMapKind.Hot, OpenStreetMapKind.GrayScale, OpenStreetMapKind.Transport }; } }
        public IEnumerable<object> OSMOverlayLayers { get { return new object[] { "None", OpenStreetMapKind.SkiMap, OpenStreetMapKind.SeaMarks, OpenStreetMapKind.HikingRoutes, OpenStreetMapKind.CyclingRoutes, OpenStreetMapKind.PublicTransport }; } }
        ...
        public IEnumerable<ProjectionBase> ProjectionTypes { get {
                return new ProjectionBase[] { new SphericalMercatorProjection(), new EqualAreaProjection(), new EquirectangularProjection(),
                    ...
                    new BraunStereographicProjection(), new KavrayskiyProjection(), new SinusoidalProjection() };
            }
        }
    }
    ...
    public class SelectedLayerToKindConverter : IValueConverter {
        #region IValueConverter implementation
        public object Convert(object value, System.Type targetType, object parameter, System.Globalization.CultureInfo culture) {
            return value is string ? OpenStreetMapKind.SkiMap : value;
        }
        public object ConvertBack(object value, System.Type targetType, object parameter, System.Globalization.CultureInfo culture) {
            return null;
        }
