...
namespace GridDemo {
    ...
    public partial class CopyPasteOperations : GridDemoModule {
        ...
        static CopyPasteOperations() {
            ...
            FocusedGridProperty = DependencyProperty.Register("FocusedGrid", typeof(FocusedGrid), typeof(CopyPasteOperations), new PropertyMetadata(FocusedGrid.None));
        ...
        FocusedGrid pastingGrid = FocusedGrid.None;
        ...
        int GetIndexForAnimationElements(int index) {
            return GetIndexForAnimationElements(index, pastingGrid == FocusedGrid.Second);
        }
